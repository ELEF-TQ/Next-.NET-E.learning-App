...
export default function Content() {
    ...
    const { chapter, chapterScore } = useSelector((state: RootState) => state.chapter);
    ...
    return (
      <div className='rounded-md flex mt-20 justify-around max-w-screen-xl mx-auto p-4 md:py-8 bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 w-full '>
        <Sidebar />
